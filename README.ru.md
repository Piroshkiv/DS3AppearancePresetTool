...
есть веб-редактор ([DSRSave](https://github.com/Piroshkiv/DSRSave)), и формат
пресета у них общий.
...
результат по подтверждению. Поэтому импорт идёт так:
...
Разбор блока целиком — [DSRSave](https://github.com/Piroshkiv/DSRSave),
`ds1-save-editor/docs/ds3-appearance.md`; исследовательский инструмент —
`tools/ds3-appearance-sweeper/` там же.
...
- проверка офсетов на сейвах и разбор face-блока — `tools/ds3-appearance-sweeper`
  в [DSRSave](https://github.com/Piroshkiv/DSRSave).
